...
<html lang="en">
  ...
  <body class="bg-dark">    
    ...
    <h1 class="bg-dark text-danger text-center p-4">{{ $list['title'] }}</h1>
    <h2 class="bg-dark text-danger text-center p-4">{{ $list['category'] }}</h2>
    <p class="bg-dark text-danger text-center p-4 fs-3" >
        {{ $list['description'] }}
    </p>
